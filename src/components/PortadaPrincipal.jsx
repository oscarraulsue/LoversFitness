    ...
    return (
        <div className="portada_Principal">
            ...
            className="imagen-portada">
                <img width="1340vw" height="650rem" src="https://res.cloudinary.com/dd01p9lb9/image/upload/v1633825295/proyecto_final/image_1_cttuin.png" alt="no disponible" srcSet="" />
           
            </div>
            <div
             hidden={isLoggedIn ? false : true}
            >
            <img width="1340vw" height="650rem" src="https://www.lavanguardia.com/files/article_main_microformat/uploads/2021/05/26/60ae6d9f84808.jpeg" alt="no disponible" srcSet="" />
           <p
