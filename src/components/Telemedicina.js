    ...
    return (
        <div className="prin">
            ...
            pensando en su beneficio.</h1>
             ...
             <Link to="/atencionmedica" type="button" className="perfil">Ver Perfil Telemedicina</Link><br />
            ...
            <h1 className="resena3"> 1. Asesorías de parte de un profesional. <br/>
             ...
             <Link className="nu" to="/atencionnutricion" type="button">Ver Perfil Nutrición</Link><br />
        </div>
    )
}
